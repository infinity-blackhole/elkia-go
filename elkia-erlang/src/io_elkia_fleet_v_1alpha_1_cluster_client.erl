...
%% @doc Unary RPC
-spec member_add(v1alpha1_fleet_pb:member_add_request()) ->
    {ok, v1alpha1_fleet_pb:member_add_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
member_add(Input) ->
    member_add(ctx:new(), Input, #{}).

-spec member_add(ctx:t() | v1alpha1_fleet_pb:member_add_request(), v1alpha1_fleet_pb:member_add_request() | grpcbox_client:options()) ->
    {ok, v1alpha1_fleet_pb:member_add_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec member_add(ctx:t(), v1alpha1_fleet_pb:member_add_request(), grpcbox_client:options()) ->
    {ok, v1alpha1_fleet_pb:member_add_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
%% @doc Unary RPC
-spec member_remove(v1alpha1_fleet_pb:member_remove_request()) ->
    {ok, v1alpha1_fleet_pb:member_remove_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
member_remove(Input) ->
    member_remove(ctx:new(), Input, #{}).

-spec member_remove(ctx:t() | v1alpha1_fleet_pb:member_remove_request(), v1alpha1_fleet_pb:member_remove_request() | grpcbox_client:options()) ->
    {ok, v1alpha1_fleet_pb:member_remove_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec member_remove(ctx:t(), v1alpha1_fleet_pb:member_remove_request(), grpcbox_client:options()) ->
    {ok, v1alpha1_fleet_pb:member_remove_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
%% @doc Unary RPC
-spec member_update(v1alpha1_fleet_pb:member_update_request()) ->
    {ok, v1alpha1_fleet_pb:member_update_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
member_update(Input) ->
    member_update(ctx:new(), Input, #{}).

-spec member_update(ctx:t() | v1alpha1_fleet_pb:member_update_request(), v1alpha1_fleet_pb:member_update_request() | grpcbox_client:options()) ->
    {ok, v1alpha1_fleet_pb:member_update_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec member_update(ctx:t(), v1alpha1_fleet_pb:member_update_request(), grpcbox_client:options()) ->
    {ok, v1alpha1_fleet_pb:member_update_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
%% @doc Unary RPC
-spec member_list(v1alpha1_fleet_pb:member_list_request()) ->
    {ok, v1alpha1_fleet_pb:member_list_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
member_list(Input) ->
    member_list(ctx:new(), Input, #{}).

-spec member_list(ctx:t() | v1alpha1_fleet_pb:member_list_request(), v1alpha1_fleet_pb:member_list_request() | grpcbox_client:options()) ->
    {ok, v1alpha1_fleet_pb:member_list_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec member_list(ctx:t(), v1alpha1_fleet_pb:member_list_request(), grpcbox_client:options()) ->
    {ok, v1alpha1_fleet_pb:member_list_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
