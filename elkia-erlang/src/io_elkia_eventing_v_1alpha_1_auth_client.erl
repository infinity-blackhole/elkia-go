...
%% @doc 
-spec auth_watch(v1alpha1_eventing_pb:auth_watch_request()) ->
    {ok, grpcbox_client:stream()} | grpcbox_stream:grpc_error_response() | {error, any()}.
auth_watch(Input) ->
    auth_watch(ctx:new(), Input, #{}).

-spec auth_watch(ctx:t() | v1alpha1_eventing_pb:auth_watch_request(), v1alpha1_eventing_pb:auth_watch_request() | grpcbox_client:options()) ->
    {ok, grpcbox_client:stream()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec auth_watch(ctx:t(), v1alpha1_eventing_pb:auth_watch_request(), grpcbox_client:options()) ->
    {ok, grpcbox_client:stream()} | grpcbox_stream:grpc_error_response() | {error, any()}.
