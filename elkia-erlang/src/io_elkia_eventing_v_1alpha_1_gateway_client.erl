...
-define(PROTO_MODULE, 'v1alpha1_eventing_pb').
...
%% @doc 
-spec channel_watch(v1alpha1_eventing_pb:channel_watch_request()) ->
    {ok, grpcbox_client:stream()} | grpcbox_stream:grpc_error_response() | {error, any()}.
channel_watch(Input) ->
    channel_watch(ctx:new(), Input, #{}).

-spec channel_watch(ctx:t() | v1alpha1_eventing_pb:channel_watch_request(), v1alpha1_eventing_pb:channel_watch_request() | grpcbox_client:options()) ->
    {ok, grpcbox_client:stream()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec channel_watch(ctx:t(), v1alpha1_eventing_pb:channel_watch_request(), grpcbox_client:options()) ->
    {ok, grpcbox_client:stream()} | grpcbox_stream:grpc_error_response() | {error, any()}.
