...
-define(PROTO_MODULE, 'v1alpha1_world_pb').
...
%% @doc Unary RPC
-spec character_add(v1alpha1_world_pb:character_add_request()) ->
    {ok, v1alpha1_world_pb:character_add_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
character_add(Input) ->
    character_add(ctx:new(), Input, #{}).

-spec character_add(ctx:t() | v1alpha1_world_pb:character_add_request(), v1alpha1_world_pb:character_add_request() | grpcbox_client:options()) ->
    {ok, v1alpha1_world_pb:character_add_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec character_add(ctx:t(), v1alpha1_world_pb:character_add_request(), grpcbox_client:options()) ->
    {ok, v1alpha1_world_pb:character_add_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
%% @doc Unary RPC
-spec character_remove(v1alpha1_world_pb:character_remove_request()) ->
    {ok, v1alpha1_world_pb:character_remove_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
character_remove(Input) ->
    character_remove(ctx:new(), Input, #{}).

-spec character_remove(ctx:t() | v1alpha1_world_pb:character_remove_request(), v1alpha1_world_pb:character_remove_request() | grpcbox_client:options()) ->
    {ok, v1alpha1_world_pb:character_remove_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec character_remove(ctx:t(), v1alpha1_world_pb:character_remove_request(), grpcbox_client:options()) ->
    {ok, v1alpha1_world_pb:character_remove_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
%% @doc Unary RPC
-spec character_update(v1alpha1_world_pb:character_update_request()) ->
    {ok, v1alpha1_world_pb:character_update_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
character_update(Input) ->
    character_update(ctx:new(), Input, #{}).

-spec character_update(ctx:t() | v1alpha1_world_pb:character_update_request(), v1alpha1_world_pb:character_update_request() | grpcbox_client:options()) ->
    {ok, v1alpha1_world_pb:character_update_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec character_update(ctx:t(), v1alpha1_world_pb:character_update_request(), grpcbox_client:options()) ->
    {ok, v1alpha1_world_pb:character_update_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
%% @doc Unary RPC
-spec character_list(v1alpha1_world_pb:character_list_request()) ->
    {ok, v1alpha1_world_pb:character_list_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
character_list(Input) ->
    character_list(ctx:new(), Input, #{}).

-spec character_list(ctx:t() | v1alpha1_world_pb:character_list_request(), v1alpha1_world_pb:character_list_request() | grpcbox_client:options()) ->
    {ok, v1alpha1_world_pb:character_list_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec character_list(ctx:t(), v1alpha1_world_pb:character_list_request(), grpcbox_client:options()) ->
    {ok, v1alpha1_world_pb:character_list_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
